...
import { Bell, ChevronDown, Home, Music, Heart, Settings, Menu, X, Search } from 'lucide-react'
import { useNavigate } from 'react-router-dom';

const navigation = [
  { name: 'Dashboard', icon: Home, href: '#', current: true },
  { name: 'Tracklist', icon: Music, href: '#', current: false },
  { name: 'Wishlist', icon: Heart, href: '#', current: false },
  { name: 'My Preferences', icon: Settings, href: '#', current: false },
]
